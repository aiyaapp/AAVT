...
//    private EGLHelper mEncodeEGLHelper;
    ...
    private Runnable mFrameEndCallback;
...
//        buffer=new byte[bufferSize];
            mAudioRecord=new AudioRecord(android.media.MediaRecorder.AudioSource.MIC,mRecordSampleRate,mRecordChannelConfig,
    ...
    public void setFrameEndCallback(Runnable runnable){
        this.mFrameEndCallback=runnable;
    }
    ...
    private Runnable mGLRunnable=new Runnable() {
        ...
        public void run() {
            if(mOutputSurface==null){
                mShowEGLHelper.setEGLSurfaceType(EGL14.EGL_PBUFFER_BIT);
            }
            ...
            while (mGLThreadFlag){
                ...
                if(mGLThreadFlag){
                    ...
                    synchronized (VIDEO_LOCK){
                        ...
                        if(mFrameEndCallback!=null){
                            mFrameEndCallback.run();
                        }
                    }
                }
            }
